...
<div
	style="background-image: url('resources/uploadimg/profile_backimg.png'); background-size: auto; background-repeat: no-repeat; width: 100%; height: 100vh;">
	<div><img src="resources/uploadimg/${m_attr.profilepic}"></div>
	<div id="mini_update">
...
<!-- 	</div> -->
	...
	<div><a href="">최신 게시글</a></div>
	<div><a href="mini_random.do?id=${mh_attr.id}">랜덤 미니홈피 가기</a></div>
