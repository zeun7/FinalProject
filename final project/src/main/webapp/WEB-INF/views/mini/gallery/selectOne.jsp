...
<!-- 로컬 서버 -->
<meta name="twitter:url" content="https://ebd7-218-146-69-112.ngrok-free.app/finalproject/gallery_selectOne.do?id=${param.id}&mbnum=${param.mbnum}" />
<!-- 배포 서버 -->
<%-- <meta name="twitter:url" content="https://175.45.201.175:8080/final$20project/gallery_selectOne.do?id=${param.id}&mbnum=${param.mbnum}" /> --%>

<script type="text/javascript">

//로컬
let url = 'http://localhost:8088/finalproject/gallery_selectOne.do?id=${param.id}&mbnum=${param.mbnum}';
// 배포서버
